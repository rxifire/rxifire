...
export type Animate<Behaviors extends {}> = Partial<{
  [K in keyof Behaviors]: <T>(v: Observable<Behaviors[K]>) => Observable<T>
}>

type AnimateToLogic<A extends Animate<any>> = { [P in keyof A]: ReturnType<NonNullable<A[P]>> }
type AnimateToView<A extends Animate<any>> = {
